...
const slides = [
  {
    id: 1,
    image: '/lightBG.png', // Or whichever image represents the terrace
    title: 'La Terrasse',
      ...
      {slides.map((slide, index) => {
        ...
        return (
          <div
            ...
            className={`relative overflow-hidden cursor-pointer transition-all duration-700 ease-out flex-shrink-0 group ${
              isActive 
          ...
          >
            ...
            <div 
              className={`absolute inset-x-0 bottom-4 flex items-center transition-all duration-700 ${
                isActive ? 'justify-start px-6' : 'justify-center px-0'
              }`}
            >
              {/* Badge Icon */}
              ...
              <div 
                className={`text-white overflow-hidden transition-all duration-700 flex flex-col justify-center whitespace-nowrap ${
                  isActive ? 'ml-4 max-w-xs opacity-100' : 'ml-0 max-w-0 opacity-0'
                }`}
              >
